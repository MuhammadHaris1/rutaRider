...
const translations = {
  ...
  es: {
    ...
    YOU_HAVE_NOT_COMPLETED_ANY_RIDE: "Aún no ha completado ningún viaje ",
    PROFILE: "Perfil",
    ...
    CVV: "CVV",
    HISTORY: "Historial",
    SCHEDULE_BOOKING: "Agenda de reservaciones",
    ...
    LOGOUT: "Salir",
    SCHEDULE_DETAIL: "Agenda",
    SCHEDULE_DETAIL_SAVED: "Agenda guardada",
    TOTAL_SEATS: "Total de asientos",
    ...
    DELETE: "Borrar",
    COMPLETED: "terminé",
    NO_ANY_USER_BOOKED_YOU: "¡Ningún usuario ha solicitado su servicio!",
    ...
    BOOKING_REQUEST_SENT_FROM_USER_TO_RIDER: "Solicitud de reservación enviada del usuario al conductor",
    ...
    ENTER_YOUR_REVIEW: "Ingresa tu reseña",
    YOUR_RATING_ADDED_SUCCESSFULLY: "Tu reseña ha sido agregada con éxito",
    ...
    DENY: "Negar",
    ALLOW: "Permitir",
    CHOOSE_AN_ACTION: "Permitir una acción",
    OK: "OK",
    RATING: "Calificación",
    ACTIVE_SCHEDULE: "Agenda activa",
    NO_ACTIVE_SCHEDULE: "Ninguna agenda activa",
    BOOKING_SCHEDULE_NOT_FOUND: "No hay reservaciones agendadas",
    ...
    RIDE_STARTS_NOW: "Viaje empieza ahora",
    YOUR_RIDE_IS_COMPLETED: "Tu viaje ha terminado",
    RIDE_IS_COMPLETED: "Viaje ha terminado",
    REVIEW_RATING: "Reseña",
