                ...
                <ImageBackground source={emergencyBack} style={{ height: "100%", width: '110%', flex: 1, justifyContent: 'center', right: 10 }}>
                    <ScrollView>
                        <View style={{ height: "100%", width: '100%', flex: 1, }}>
                            ...
                            <View style={Platform.OS == "ios" ? { width: widthPercentageToDP(75), alignSelf: 'center' } : { borderRadius: 30, borderColor: '#3A91FA', borderWidth: 1, marginVertical: '2%', width: widthPercentageToDP(75), alignSelf: 'center' }}>
                                {this.props.fetching ?
                                    <Spinner color="#000" />
                                    :
                                    <Picker
                    ...
                    <View style={{ position: "absolute", bottom: 100, width: '100%' }}  >
                        <Button
                            ...
                            style={{
                                width: '40%', alignSelf: 'center', marginTop: 5,
                                backgroundColor: 'rgba(45, 48, 67, 0.8)'
                            }} full rounded>
