...
import { getPaymentDetails, updateVehicle, getHistory, getUserDetail, getEmergencyNumber, getSchedule } from '../../.././../Redux/Actions/userAction'
...
class Profile extends React.Component {
    ...
    componentDidMount = () => {
        const { userDetails, getHistory, getPaymentDetails, getEmergencyNumber, getSchedule } = this.props        
...
const mapDispatchToProps = {
    updateVehicle, getHistory, getPaymentDetails, getUserDetail, getEmergencyNumber, getSchedule
};
